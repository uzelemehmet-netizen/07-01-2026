...
function DestinationDetailPage() {
  ...
  const tabs = [
    { id: "gezilecek", label: "Gezilecek Yerler", icon: Landmark },
    { id: "aktiviteler", label: "Aktiviteler", icon: Waves },
    { id: "yiyecek", label: "Yiyecek & İçecek", icon: Utensils },
    { id: "konaklama", label: "Konaklama", icon: Coffee },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#121212] flex flex-col">
      ...
      <div className="flex-1">
        ...
        <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] overflow-hidden">
          <img
            src={detail.images?.[0] || defaultDetail.images[0]}
            alt={detail.name}
          ...
          <div className="absolute bottom-0 left-0 right-0 px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12">
            <nav className="mb-2 text-[11px] sm:text-[12px] font-poppins text-white/80 flex flex-wrap items-center gap-1">
              <a href="/kesfet" className="hover:underline">Endonezya</a>
          ...
          <div className="max-w-none ml-0 px-3 sm:px-6 lg:px-8 py-2 sm:py-3">
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-3">
              ...
              >
                ...
                <span>{detail.island} adasına dön</span>
              </a>
            </div>
          </div>
        </div>
              ...
              <div className="flex-1 min-w-0">
                <div className="max-w-5xl">
                  <div className="mb-6 text-[11px] sm:text-[12px] font-poppins text-[#6D6D6D] dark:text-[#A0A0A0] flex flex-wrap gap-2">
                    <span>Bugün ortalama hava: 28°C · Deniz: 27°C (tahmini)</span>
                  </div>
              ...
              {activeTab === "gezilecek" && (
                <div className="space-y-6">
                  <h2 className="text-[22px] sm:text-[24px] font-poppins font-semibold text-[#6A54E7] dark:text-[#C4B5FF] mb-1 text-balance">
                    {detail.name}'de önce nereleri görmelisin?
                  </h2>
                  <p className="text-[12px] sm:text-[13px] font-poppins text-[#6D6D6D] dark:text-[#A0A0A0] mb-6 leading-relaxed text-balance">
                    Manzaradan tarihe, {detail.name}'i gerçekten hissettirecek durakları burada topladık.
                  </p>
                  ...
                  <div className="mt-6 bg-[#F5F3FF] dark:bg-[#1E1B2E] border border-[#E0D9FF] dark:border-[#3F3B66] rounded-xl p-4 text-[12px] sm:text-[13px] font-poppins text-[#4338CA] dark:text-[#E0E7FF]">
                    {detail.name}'e ilk kez geliyorsan, günde en fazla 2-3 noktayı planlayıp aralara mola koyman hem havayı hem de ritmi daha iyi hissetmeni sağlar.
                  </div>
                </div>
              )}
              ...
              {activeTab === "aktiviteler" && (
                <div className="space-y-6">
                  <h2 className="text-[22px] sm:text-[24px] font-poppins font-semibold text-[#0EA5E9] dark:text-[#7DD3FC] mb-1 text-balance">
                    {detail.name}'de neler yapmadan dönmemelisin?
                  </h2>
                  <p className="text-[12px] sm:text-[13px] font-poppins text-[#6D6D6D] dark:text-[#A0A0A0] mb-6 leading-relaxed text-balance">
                    Sakin bir gün planlamak ya da adrenalin peşine düşmek, aşağıdan hangisini seçeceğine bağlı.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                  ...
                  <div className="mt-6 bg-[#E0F7FF] dark:bg-[#082F3C] border border-[#BAE6FD] dark:border-[#155E75] rounded-xl p-4 text-[12px] sm:text-[13px] font-poppins text-[#0369A1] dark:text-[#E0F2FE]">
                    Aynı gün içinde hem çok hareketli hem de çok sakin aktiviteleri karıştırmak, {detail.name}'de geçirdiğin zamanı daha dengeli ve akılda kalıcı yapar.
                  </div>
                </div>
              )}
              ...
              {activeTab === "yiyecek" && (
                <div className="space-y-6">
                  <h2 className="text-[22px] sm:text-[24px] font-poppins font-semibold text-[#FF8940] dark:text-[#FFB45C] mb-1 text-balance">
                    {detail.name}'de nelerin tadına bakmalısın?
                  </h2>
                  <p className="text-[12px] sm:text-[13px] font-poppins text-[#6D6D6D] dark:text-[#A0A0A0] mb-6 leading-relaxed text-balance">
                    Sokak lezzetlerinden sakin akşam yemeklerine kadar, pişman olmadan denemen gereken tatları derledik.
                  </p>
              ...
              {activeTab === "konaklama" && (
                <div className="space-y-4">
                  <h2 className="text-[22px] sm:text-[24px] font-poppins font-semibold text-[#10B981] dark:text-[#6EE7B7] mb-1 text-balance">
                    {detail.name}'de nasıl bir yerde kalmak sana iyi gelir?
                  </h2>
                  <p className="text-[12px] sm:text-[13px] font-poppins text-[#6D6D6D] dark:text-[#A0A0A0] mb-6 leading-relaxed text-balance">
                    Bütçene, konfor beklentine ve manzara hayaline göre seçenekleri yan yana görebilirsin.
                  </p>
                    ...
                    <div className="bg-gradient-to-r from-[#FFF8F5] to-[#FFF0E8] dark:from-[#2E2E2E] dark:to-[#262626] border border-[#FF8940]/30 dark:border-[#FF9D55]/30 rounded-xl p-6 mb-6">
                      <div className="flex flex-col sm:flex-row gap-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-[12px] font-poppins font-semibold text-[#FF8940] dark:text-[#FF9D55] uppercase tracking-wide">Önerilen Süre</p>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-[12px] font-poppins font-semibold text-[#FF8940] dark:text-[#FF9D55] uppercase tracking-wide">Toplam Ortalama Bütçe ({detail.konaklamaSuresi})</p>
                            <p className="text-[16px] sm:text-[18px] font-poppins font-bold text-black dark:text-white mt-1">
                  ...
                  <div className="mt-6 bg-[#FFF8F5] dark:bg-[#2E2E2E] border border-[#FED7AA] dark:border-[#9A3412] rounded-xl p-4 text-[12px] sm:text-[13px] font-poppins text-[#9A3412] dark:text-[#FED7AA]">
                    Çok acıkmadan önce hafif bir sokak lezzeti, akşam için ise daha sakin bir restoran seçmek {detail.name}'de gününü daha keyifli dengeler.
                  </div>
                  ...
                  <div className="mt-6 bg-[#E6FFF7] dark:bg-[#064E3B] border border-[#A7F3D0] dark:border-[#10B981] rounded-xl p-4 text-[12px] sm:text-[13px] font-poppins text-[#065F46] dark:text-[#D1FAE5]">
                    {detail.name}'de konaklama seçerken, ilk geceyi daha merkezi bir bölgede, devam eden günleri ise daha sakin bir bölgede planlamak adaptasyonu kolaylaştırır.
                  </div>
                </div>
              )}
              ...
              {activeTab === "alisveris" && (
                <div className="space-y-6">
                  <h2 className="text-[22px] sm:text-[24px] font-poppins font-semibold text-[#EC4899] dark:text-[#F9A8D4] mb-1 text-balance">
                    {detail.name}'da hem ihtiyacın hem hediyen için neler bulabilirsin?
                  </h2>
                  <p className="text-[12px] sm:text-[13px] font-poppins text-[#6D6D6D] dark:text-[#A0A0A0] mb-6 leading-relaxed text-balance">
                    Acil ihtiyaçların, aktiviteler için ekipmanlar ve sana burayı hatırlatacak küçük şeyler için fikirler burada.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                  ...
                  <div className="mt-6 bg-[#FFE4F3] dark:bg-[#3B082F] border border-[#F9A8D4] dark:border-[#BE185D] rounded-xl p-4 text-[12px] sm:text-[13px] font-poppins text-[#9D174D] dark:text-[#FCE7F3]">
                    Hatıralık alışverişi genelde son güne bırakma; {detail.name}'de beğendiğin şeyleri gördüğün gün almak, hem pazarlıkta hem seçimlerde daha rahat olmanı sağlar.
                  </div>
                </div>
              )}
                ...
                >
                  {getImagesForActiveTab().map((img, idx) => (
                    ...
                    >
                      <img
                        src={img}
                        alt={`${detail.name} - ${activeTab} view ${idx + 1}`}
